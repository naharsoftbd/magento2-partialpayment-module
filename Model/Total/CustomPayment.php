...
namespace Magento\AdditionalPayment\Model\Total;
 ...
 */
class CustomPayment extends Address\Total\AbstractTotal
{
    /**
     * @var FeeHelper
     */
    ...
    public function collect(Quote $quote, ShippingAssignmentInterface $shippingAssignment, Address\Total $total)
    {
        ...
        $total->setCustomPayment($fee);
        $quote->setCustomPayment($fee);
